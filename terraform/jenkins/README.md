...
* Creates security group for Jenkins EC2 machine.
* EC2 machine for Jenkins to run on.
...
* !!! Meanwhile it is just an empty EC2 instance, it is important that this machine specifically is utilized to run Jenkins as security groups are tuned specifically for that.
## Prerequisites
* Have Git installed
...
* Use `cd <path-to-copied-repository>/main/terraform/jenkins`
